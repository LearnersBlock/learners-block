...
class auth_log_in(Resource):
    def post(self):
        ...
        verify_password = User.verify_password(
            content["password"], lb_database.password
        )

        username = content["username"].lower()

        if username != lb_database.username or verify_password is not True:
...
class auth_verify_user_password_state(Resource):
    def get(self):
        ...
        verified_password = User.verify_password(" ", lb_database.password)
