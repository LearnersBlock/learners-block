...
if __name__ == "__main__":
    ...
    with app.app_context():
        ...
        from resources.app_store_routes import (
            appstore_get_apps,
            appstore_status,
        )
        from resources.auth_routes import (
            auth_log_in,
            auth_log_out,
            auth_set_password,
            auth_verify_login,
            auth_verify_user_password_state,
            auth_wifi_password_state,
        )
        from resources.settings_routes import (
            settings_default_startpage,
            settings_get_ui,
            settings_set_ui,
        )
    ...
    if config.dev_mode:
        ...
        from resources.dev_routes import (
            supervisor_device,
            supervisor_host_config,
            supervisor_hostname,
            supervisor_journal_logs,
            supervisor_state,
            supervisor_update,
            supervisor_uuid,
            wifi_connect,
        ...
        from resources.supervisor_routes import (
            supervisor_device,
            supervisor_host_config,
            supervisor_hostname,
            supervisor_journal_logs,
        ...
        from resources.wifi_routes import (
            wifi_connect,
            wifi_connection_status,
            wifi_forget,
            wifi_forget_all,
    ...
    api.add_resource(
        auth_verify_user_password_state, "/v1/auth/verify_user_password_state"
    )
    api.add_resource(auth_wifi_password_state, "/v1/auth/wifi_password_state")
    ...
    # Settings
    api.add_resource(
        settings_default_startpage, "/v1/settings/default_startpage"
    )
