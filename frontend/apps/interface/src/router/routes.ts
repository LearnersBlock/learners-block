...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: '/library', component: () => import('pages/library/Library.vue'), name: 'library' },
      { path: '/library/resource/:id', component: () => import('pages/library/Resource.vue'), name: 'library_resource' },
